    ...
    return (
        <div className="px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Cancer Screening */}
                <div className="border border-gray-200 rounded-xl bg-green-50 p-4 shadow-sm">
                ...
                {/* Heart Health Risk */}
                <div className="border border-gray-200 rounded-xl bg-yellow-50 p-4 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
            ...
            <div className="border border-gray-200 mt-8 p-6 bg-blue-50 rounded-xl shadow-sm flex flex-col sm:flex-row sm:space-x-4">
                {/* Icon on the left */}
                ...
                <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <button className="flex items-center justify-center bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 w-full sm:w-auto">
                            <FileText className="w-4 h-4 mr-2" />
                            Show Full Report
                        </button>
                        <button className="flex items-center justify-center border border-blue-600 text-blue-600 px-4 py-2 rounded-lg text-sm hover:text-black hover:border-black hover:bg-gray-50 w-full sm:w-auto">
            ...
            {/* Next Steps */}
            <div className="border border-gray-200 bg-purple-100 rounded-3xl shadow-xl overflow-hidden p-6 sm:p-8 mt-5">
                <div className="text-center mb-8">
                    <h2 className="text-2xl sm:text-3xl font-bold text-purple-800">Next Steps</h2>
                    <p className="text-base sm:text-lg text-purple-500 mt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-2xl p-6 text-center flex flex-col items-center justify-center border border-purple-200">
                ...
                <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                    <button className="flex items-center justify-center bg-purple-600 text-white font-medium py-3 px-6 rounded-lg shadow-md hover:bg-purple-700 transition-colors duration-200 w-full sm:w-auto">
                        <MessageCircleCode className="w-5 h-5 mr-2" />
                        Review With Navigator
                    </button>
                    <button className="flex items-center justify-center bg-white text-purple-600 font-medium py-3 px-6 rounded-lg border border-purple-600 hover:bg-gray-100 transition-colors duration-200 w-full sm:w-auto">
                ...
                {/* Footer */}
                <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 text-xs text-gray-500 text-center">
