...
const AiTabs = () => {
  ...
  className="items-center justify-center rounded-lg grid w-full grid-cols-1 sm:grid-cols-3 mb-8 bg-white border border-gray-200 shadow-sm h-auto sm:h-10"
>
  {[
    ...
    <button
      ...
      className={`inline-flex sm:h-[calc(100%-1px)] w-full sm:flex-1 items-center justify-center gap-1.5 rounded-lg border border-transparent px-2 py-2 sm:py-1 text-sm sm:text-base transition-colors ${
        activeTab === tab.id
