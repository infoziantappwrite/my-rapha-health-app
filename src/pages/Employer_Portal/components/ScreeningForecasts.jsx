...
const ScreeningForecasts = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Main Card */}
      <div className="bg-white text-gray-800 flex flex-col gap-6 rounded-xl border shadow-lg border-blue-200">
        {/* Header */}
        <div className="px-6 pt-6 border-b border-blue-200 pb-6">
          <h4 className="flex items-center space-x-2 font-semibold text-gray-900">
            ...
            <span className="ml-2 bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded-md font-medium">
              Predictive
            </span>
          </h4>
        </div>
...
<div className="px-4 sm:px-6 flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
  ...
  <button className="flex items-center w-full sm:w-auto px-3 py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">
    ...
    Export Forecast
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="bg-green-100 text-green-800 px-2 py-0.5 text-xs rounded-md">
                    ▲
                  </span>
                </div>
        ...
        {/* Forecast Insight */}
        <div className="bg-green-50 p-4 rounded-lg border border-green-200 mx-6 mb-6">
