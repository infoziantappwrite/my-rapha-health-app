...
const CohortIntelligence = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Main Card */}
      <div className="bg-white flex flex-col gap-6 rounded-xl border shadow-lg border-purple-200">
        {/* Header */}
        <div className="px-6 pt-6 border-b border-purple-200 pb-6">
          <h4 className="flex items-center space-x-2 font-semibold text-gray-900">
            ...
            <span className="ml-2 bg-purple-100 text-purple-800 text-xs px-2 py-0.5 rounded-md font-medium">
              Comparative
            </span>
          </h4>
        </div>
        ...
        <div className="px-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="text-sm font-medium mb-2 block">Cohort A</label>
            <button className="flex w-full items-center justify-between px-3 py-2 border border-gray-300 rounded-md text-sm bg-white hover:bg-gray-50">
              Remote Workers
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <label className="text-sm font-medium mb-2 block">Cohort B</label>
            <button className="flex w-full items-center justify-between px-3 py-2 border border-gray-300 rounded-md text-sm bg-white hover:bg-gray-50">
              Onsite Staff
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="px-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="bg-red-100 text-red-800 px-2 py-0.5 text-xs rounded-md font-medium">
                42% Complete
              </span>
            </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-4">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-medium">Onsite Staff</h4>
              <span className="bg-green-100 text-green-800 px-2 py-0.5 text-xs rounded-md font-medium">
                76% Complete
              </span>
            </div>
            <div className="space-y-3 text-sm">
        ...
        {/* AI Cohort Analysis */}
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl mx-6 mb-6 p-4">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <span className="font-medium text-purple-900">AI Cohort Analysis</span>
          </div>
          <div className="text-sm text-purple-800 space-y-2">
            ...
            <p className="bg-white p-3 rounded-lg border border-purple-200">
