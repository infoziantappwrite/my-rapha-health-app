    ...
    return (
       ...
       <header className="flex items-center justify-between p-4 mb-1 bg-white shadow-md">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="hidden md:flex items-center px-4 py-2 bg-sky-100 text-sky-700 rounded-full font-medium shadow-inner">
                        <Clock size={16} className="mr-2" />
            ...
            {isMenuOpen && createPortal(
                <div className="fixed inset-0 z-50 flex justify-end">
                    ...
                    <div className="relative w-full max-w-sm bg-white shadow-xl flex flex-col h-full animate-slide-in text-sm">
